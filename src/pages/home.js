...
function Home() {
    return (
        <section className="container col-f outer-card f-content">
            ...
            <div id="about" className="container row-f section f-center-c">
                <div className="container col-f flex-1-combo f-center-c">
                    <div style={{ gap: '3rem' }} className="container row-f flex-1 f-warp">
                        <div className="container col-f flex-1 f-center-c">
                            <h2 style={{ color: 'yellow' }}>About Me</h2>
                            <div className="container row-f f-center" style={{ marginBlock: '2rem' }}>
                                <p style={{ textAlign: 'justify', fontSize: '125%', fontWeight: '500' }}>
                                    "I am Ahmad Akbar, an active undergraduate student, majoring in Information Systems, Universitas Dinamika Bangsa. I am interested in visual science and computer science, and technology. I am interested in web development."
                                </p>
                            </div>
                        </div>
                        <div className="container col-f flex-1 f-center-c">
                            <h2 style={{ color: 'yellow' }}>My Skils On</h2>
                            <p style={{ textAlign: 'justify', fontSize: '125%', fontWeight: '500' }}>
                                    "My skills lie in the field of multimedia and technology, particularly in website development."
                                </p>
                            <div className="container row-f f-center" style={{ marginBlock: '2rem' }}>
                                <div style={{ height: '50px' }} className="container row-f f-between flex-1">
                                    <img className="img-xs" src={`${myUrl}/asset/icons/DaVinci_Resolve_17_logo.svg`} alt="" />
                                    <img className="img-xs" src={`${myUrl}/asset/icons/Inkscape_Logo.svg`} alt="" />
                                    <img className="img-xs" src={`${myUrl}/asset/icons/Figma.svg`} alt="" />
                                    <img className="img-xs" src={`${myUrl}/asset/icons/HTML5 Logo.svg`} alt="" />
                                    <img className="img-xs" src={`${myUrl}/asset/icons/CSS3_logo.svg`} alt="" />
                                    <img className="img-xs" src={`${myUrl}/asset/icons/Unofficial_JavaScript_logo_2.svg`} alt="" />
                                    <img className="img-xs" src={`${myUrl}/asset/icons/logos--supabase-icon.svg`} alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <p>Check out my social media.</p>
                    <div style={{ height: '50px', width: '100%', maxWidth: '300px' }} className="container row-f f-between flex-1">
            ...
            <div id="experience" className="container swap section">
                <div className="container col-f flex-1">
                    <h2>These are</h2>
                    <p style={{ fontWeight: 'bold', fontSize: '250%', color: 'yellow' }} >My Experience</p>
                </div>
                <div className="container col-f flex-1">
                    <ol style={{ marginLeft: '1rem' }} type="1">
                        ...
                        <li>
                            <section className="container col-f">
                                <p>
                                    Through the Kampus Merdeka program, I successfully completed a self-study in Front-End and Back-End Web Development at Dicoding Academy for approximately 5 months, from February to June 2024.
                                </p>
                ...
                <div className="container col-f">
                    <section style={{ gap: '1rem' }} className="grid grid-col-1 grid-col-2 grid-col-3">
                        <div className="container col-f f-between card">
                            ...
                            <p>Sertifikat Kelulusan Kelas Program Logic 101</p>
                        ...
                        <div className="container col-f f-between card">
                            ...
                            <p>Sertifikat Kelulusan Studi Independen di Dicoding Academy</p>
                        </div>
                        <div className="container col-f f-between card">
                            ...
                            <p>Sertifikat Kepersertaan Studi Independen - Kampus Merdeka</p>
                        </div>
                    </section>
                </div>
            </div>
